...
public class JeuxDeDonneesTest {
	...
	/*
	 * @Test public void test_cotisationsNonImposables() { List<Cotisation>
	 * cotisationsNonImposables =
	 * bulletin1.getRemunerationEmploye().getProfilRemuneration()
	 * .getCotisationsNonImposables(); Stream.of("EP01", "EP02", "EP03", "EP04",
	 * "EP05", "EP06", "EP07", "EP12", "EP19", "EP20", "EPR1", "E900", "EP28",
	 * "EP37") .forEach(code -> assertTrue("verification code " + code,
	 * cotisationsNonImposables.stream().filter(c ->
	 * c.getCode().equals(code)).findAny().isPresent())); }
	 * 
	 * @Test public void test_cotisationImposables() { List<Cotisation>
	 * cotisationsImposables = bulletin1.getRemunerationEmploye()
	 * .getProfilRemuneration() .getCotisationsImposables(); Stream.of("SP01",
	 * "SP02") .forEach(code -> assertTrue("verification code " + code,
